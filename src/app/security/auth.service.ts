// Created from Project start process :
// https://github.com/Tazaf/masrad-project-starter/blob/master/citizen-engagement-starter.md#create-an-authentication-service
...
export class AuthService {
  ...
  logout() {
    ...
    //Removed :     this.authenticated$.next(null);
